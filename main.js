...
function checkEmail(text) {
  return /^[a-zA-Z]+\W?[a-zA-Z]+@[a-zA-Z\.]+\.[a-z]{2,3}$/.test(text);
}
...
function checkDomainUrl(text) {
  return /^(http:|https:)\/\/(?!:\/\/)([a-zA-Z0-9-_]+\.)*[a-zA-Z0-9-_][a-zA-Z0-9-_]+\.[a-zA-Z]{2,5}?$/.test(text);
}
